...
## Pricing the exit: what a mid-hold home sale does to the comparison

*(Added rev 4 — the tables above assume the lease keeps running to the horizon, which is only true if you never sell, or transfer the lease to a buyer cleanly.)* Part 1's honest confidence window is 10-15 years in the house. If the house sells mid-lease, the exit is either transferring the lease to the buyer — real friction: the buyer must qualify and accept an escalating $152+/mo obligation, which shrinks the buyer pool and invites a price concession — or exercising the FMV buyout. Pricing the buyout exit (current charging pattern, PG&E +5%/yr; buyout assumed to decline straight-line from the quoted $19,028 at year 5 to $0 at year 25 — an assumption *generous* to the lease, given the industry pattern of FMV quotes running 20-30% above appraisal):

| Sell at | Do nothing | Ownership | Lease + buyout at sale |
|---|---|---|---|
| 5yr | $19.3k | $32.6k | $36.7k |
| 7yr | $28.5k | $36.9k | $42.7k |
| 10yr | $44.0k | $44.2k | $52.8k |
| 15yr | $75.4k | $68.5k (incl. $10k replacement) | $73.2k |

- **If a sale triggers a buyout, ownership beats the lease at every horizon from year 5 on** (~$4-9k ahead) — before counting any owned-system resale premium, and before the buyout comes in above the straight-line assumption (a +25% buyout adds another ~$2.4-4.8k to the lease column). This gap is independent of both the charging pattern and the rate-escalation assumption: both paths pay the identical PG&E bill, so the comparison reduces to (lease payments + buyout) vs. (purchase price + maintenance/replacement).
- **Before year 5 the lease has no buyout option at all** — a sale means lease transfer or an early-termination fee ($5,000-40,000 industry range). (Corda's structure carries the mirror-image friction in years 1-5: the credit agreement must be assigned to the buyer; after the year-5 transfer it's a clean owned asset.)
- **Selling early hurts every solar path vs. doing nothing**: at a year-7 sale, ownership is ~$8k behind no-solar and lease+buyout ~$14k behind. The one rescue is the owned-system resale premium — even half the Berkeley Lab ~$4/W figure (~$11k on this system) flips ownership positive vs. doing nothing around year 7-8. No equivalent exists for the lease: handing a buyer a 25-year escalating payment obligation is a liability at sale time, not an asset.
- **Net effect on the instrument choice**: the lease's years-9-17 advantage in the tables above exists only in the "stay put the whole time (or transfer cleanly)" scenario. If a mid-hold sale is realistically on the table, the lease drops out and the decision collapses to **ownership vs. doing nothing** — which turns on the Part 1 questions (rate trajectory, horizon, resale premium).

## Bottom line on Part 2

With Corda's credit structure confirmed and the comparison re-run at the right size, **ownership (~$23k est.) is the stronger pure-financial instrument for a confident long hold — the crossover vs. the lease sits around year 17**: better cost from there out even with replacements priced in, immune to the lease escalator, ~9-11% expected IRR, and it survives the flat-rate scenario. **The lease remains the defensible choice only if capital preservation and risk transfer matter more than long-run cost AND you're confident you'll stay put** — it's positive from day one, Tesla carries equipment risk, and daytime charging hedges its worst scenario — but its advantage assumes the lease runs undisturbed: a mid-hold home sale that forces a buyout hands the win to ownership at every horizon from year 5 on (see "Pricing the exit" above), and it is in any case the more leveraged bet on PG&E rates and the harder contract to leave. First step either way: get Corda's real quote at 13-14 panels to replace the ~$23k estimate.
...
**Addition (2026-08-15, rev 4)**: new Part 2 section "Pricing the exit" — the head-to-head and outlook tables assumed the lease runs undisturbed to the horizon, silently ignoring that a mid-hold home sale forces a lease transfer or an FMV buyout. Priced explicitly (straight-line-declining buyout from the quoted $19,028 at year 5), a sale-triggered buyout makes ownership cheaper than the lease at every horizon from year 5 on, shrinking the lease's honest niche to "capital preservation + confident you'll stay put." Part 2's bottom line updated accordingly. Not a calculation error in the existing tables — a scenario they didn't cover.
