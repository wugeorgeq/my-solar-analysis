# Corda Solar Quote — Reference

Quote #10611972 | Prepared by Nathan Collins, Corda Solar | Valid until 2026-09-14
Corda Solar, LLC, 523 San Ramon Valley Blvd, Danville CA. CSLB #1019424 (C-46 solar, C-10 electrical). In business since June 2007. Nathan co-owner since 2021; founders Gary & Courtney Corda in San Ramon Valley since 1994.

Source: Corda Solar proposal PDF (local copy not included in this folder)

## System Option 1: 19 Panels + 1x Tesla Powerwall 3
- Panels: 19 x Hyundai HiN-T440NF(BK), 440W each = 8.36 kW total
- Production estimate: 10,910 kWh/yr (1,305 kWh/kW/yr — roof-specific, lower than generic ~1,550 kWh/kW/yr assumption)
- Inverter: Tesla Powerwall 3.0, 11.5kW rating, 6 MPPTs
- Battery: 1x Tesla Powerwall 3, 13.5 kWh
- Warranties: 25yr panel product / 30yr panel performance / 10yr inverter / 10yr battery
...
**Their stated financials:** Year-1 savings $2,402 | Payback 8yr7mo | Discounted payback 9yr10mo (3% discount rate) | NPV $33,696 | Total ROI 248% | IRR 12.0% | Lifetime (25yr) bill savings $85,387 | "Consumption offset" 110% (production/consumption ratio, NOT self-consumption rate)

## System Option 2: 19 Panels + 2x Tesla Powerwall 3
- Same panels/production as Option 1
- Battery: 2x Tesla Powerwall 3, 27.0 kWh total (2nd unit = $8,200 "Expansion pack", matches Tesla's real pricing)

**Pricing:**
- Total System Price (gross): **$48,738**
- 30% Credit: $14,621.40 (same PPA caveat as above)
- Purchase Price (post-credit): **$34,116.60**
- DSGS estimate: $7,699.86 → haircut to ~$3,850
- Net System Cost: $26,416.74

**Their stated financials:** Year-1 savings $2,435 | Payback 8yr11mo | Discounted payback 10yr3mo | NPV $50,447 | ROI 352% | IRR 12.7% | Lifetime savings $119,510

## Bill modeling assumptions (Corda's, worth challenging)
- Used generic default rate plan "Residential TOU (Peak Pricing 4pm-9pm Everyday) Region X Basic" — NOT verified against George's actual PG&E tariff
- Assumed usage: 9,908 kWh/yr (close to our real measured 9,017-9,166 kWh/yr)
- Modeled 2026 "before" bill: $3,401/yr (vs. our real measured $3,496-3,708/yr — same ballpark)
